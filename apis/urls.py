...
from views import accounts_detail, products_detail, categories_detail, account_types, AccountList, AccountDetail, AccountGenericList, AccountUpdateGenericList, AccountListView, AccountRetrieveView, VendorDetail, VendorList, ProductsList, AllProductsList
...
urlpatterns = [
	...
	url(r'^account_by_class/(?P<id>\d+)', AccountDetail.as_view()),
